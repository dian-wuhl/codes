...
public class JwtTokenUtil {
    ...
    public String getUserCodeFromToken(String token) {
        ...
        try {
            ...
            userCode = claims.get(CLAIM_KEY_USERCODE, String.class);
        } catch (Exception e) {
        }
        return userCode;
    }
     ...
     */
    public String generateByUserIdAndCode(Long userId, String userCode) {
        Map<String, Object> claims = new HashMap<>();
        claims.put(CLAIM_KEY_USERID, userId);
        claims.put(CLAIM_KEY_USERCODE, userCode);
     ...
     * 加密： 根据用户名生成token（项目使用）
     */
    public String generateByUserCode(String userCode) {
        Map<String, Object> claims = new HashMap<>();
        claims.put(CLAIM_KEY_USERCODE, userCode);
        claims.put(CLAIM_KEY_CREATED, new Date());
        return generateToken(claims);
